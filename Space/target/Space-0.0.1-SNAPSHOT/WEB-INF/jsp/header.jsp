...
<nav class="navbar navbar-fixed-top navbar-inverse"
	style="background: #014899; height: 60px">
	<div class="container">
	...
	<div class="index_nav">
		<div class="nav">
			<ul>
				...
				<li><a href="${ctx }/">场地介绍</a>
				<li><a href="${ctx }/apply">场地预约</a>
				<li><a href="${ctx }/"  data-toggle="dropdown">活动中心</a>
					<ul class="dropdown-menu" style="left: 300px">
						<li><a href="${ctx }/act/foredetail/16">当前活动</a></li>
