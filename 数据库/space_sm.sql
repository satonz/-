...
CREATE TABLE `tb_action`  (
  ...
  `action_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tb_activity`  (
  ...
  `act_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `act_add_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tb_application`  (
  ...
  `app_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tb_authentication`  (
  ...
  `inf_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `tb_barrage`  (
  ...
  `barr_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `tb_comment`  (
  ...
  `comment_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `act_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `tb_comminform`  (
  ...
  `comminform_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tb_notice`  (
  ...
  `notice_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `tb_sysinform`  (
  ...
  `sysinform_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user_id` int(11) NOT NULL,
  `is_readed` tinyint(4) NOT NULL,
...
CREATE TABLE `tb_ticket`  (
  ...
  `ticket_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `act_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
